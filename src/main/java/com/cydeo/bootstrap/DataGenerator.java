...
@Component
public class DataGenerator implements CommandLineRunner {   //commandlinerunner is given by spring boot. Whenever the app is run it is executed first
    ...
    public void run(String... args) throws Exception {
        ...
        // add data to map  using .save method
